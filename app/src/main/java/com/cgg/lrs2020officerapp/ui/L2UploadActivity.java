...
public class L2UploadActivity extends AppCompatActivity implements ErrorHandlerInterface {
    ...
    String short_fall, fee_intimation, area_match, abutting_road, recommended_officer_remarks, value_ason, pNo_objection, land_use, land_use_id, recomend, recomend_id, verification;
